...
export const VideoItemResponsiveMainContainer = styled.div`
  height: 100vh;
...
export const ContactIcons = styled.img`
  ...
  width: 35px;
`
export const VideoItemResponsiveContainer = styled.div`
   width: 100%;
...
`
export const VideosViewsItemContainer = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: flex-start;
  margin-top: 15px;
...
export const VideoItemTitle = styled.p`
  color: ${props => (props.isTheme ? '#383838' : '#f9f9f9')};
  font-family: 'Roboto';
  font-size: 22px;
  margin-left: 10px;
...
`
export const VideoItemDetailss = styled.p`
...
width : 100%;
border: 1px solid ${props => (props.isTheme ? '#1e293b' : '#cbd5e1')};
...
export const VideosDescripition = styled.p`
  color: ${props => (props.isTheme ? '#606060' : '#cbd5e1')};
  font-family: 'Roboto';
  font-size: 18px;
  margin-top: 20px;
  margin-left: 60px;
...
`
export const LikesFlexContainer = styled.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
...
`
export const LikesContent = styled.button`
  background-color: transparent;
  border-width: 0px;
  cursor: pointer;
...
`
export const LikeResposiveContainer = styled.div`
  display: flex;
  flex-direction: row;
  align-items: center;
