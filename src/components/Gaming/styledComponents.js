...
export const GamingRespinsiveContainer = styled.div`
  height: 100vh;
...
export const GamingIconContainer = styled.div`
  ...
  align-items: center;
`
export const GamingContent = styled.h1`
...
`
export const GamingVideosMainContainer = styled.ul`
  height: 70vh;
  width: 100%;
  display: flex;
  flex-direction: row;
...
`
export const GamingVideosListContainer = styled.li`
  list-style-type: none;
  margin-top: 15px;
  margin-left : 20px;
  margin-bottom: 20px;
...
`
export const GamingVideoTDetails = styled.p`
  color: ${props => (props.isTheme ? '#7e858e' : '#94a3b8')};
  font-family: 'Roboto';
  font-size: 18px;
  margin-top: 5px;
  margin-bottom: 0px;
